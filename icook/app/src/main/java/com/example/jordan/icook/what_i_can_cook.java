...
public class what_i_can_cook extends AppCompatActivity {
    private static final String TAG = "whatICanCook";
    private Cursor cur;
    ...
    int igCount = 0; //for Recipe Checks
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ready_to_cook);
    ...
    private void MenuButtons(){
        ...
        ButtonhomeRA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ButtonhomePA = new Intent(what_i_can_cook.this, MainActivity.class);
        ...
        ButtonrecipeRA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ButtonrecipeRA = new Intent(what_i_can_cook.this, ListPantry.class);
    ...
    private void populateListView(String i) {
        ...
        ListView myList = findViewById(R.id.ListReadyRecipe);
...
//////////////////////////////////////////////////////////
    public void addItem(){
        btnAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent RecipeAdd = new Intent(what_i_can_cook.this, RecipeActivity.class);
